...
"""
In this function we assume that given config is methods and utils config and
no any other, we just perform validation of it so it always need to have some
attributes and also those attributes need to have some specific values
"""
...
def read_config(config_path: str) -> dict:
    ...
    try:
        ...
        msg = f"App.otherFunctions.readConfig: Provided incorrect " \
              f"configuration path! given path is: {config_path}"
